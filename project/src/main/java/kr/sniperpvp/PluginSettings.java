...
public record PluginSettings(
    ...
    static PluginSettings load(FileConfiguration config) {
        ...
        GameSettings game = new GameSettings(
            ...
            positive(config.getDouble("game.jump-strength", 0.72),
                "game.jump-strength"),
            positive(config.getDouble("game.player-scale", 1.5),
                "game.player-scale"),
            positive(config.getDouble("game.max-health", 100.0), "game.max-health"),
            nonNegative(config.getDouble("game.absorption", 50.0), "game.absorption"),
        ...
        RifleSettings rifle = new RifleSettings(
            ...
            positive(config.getDouble("rifle.damage.legs", 70.0), "rifle.damage.legs"),
            positive(config.getDouble("rifle.damage.body", 100.0), "rifle.damage.body"),
            positive(config.getDouble("rifle.damage.head", 150.0), "rifle.damage.head"),
    ...
    public record RifleSettings(
        ...
        double horizontalAimOffsetBlocks,
        int cooldownTicks,
        int magazineSize,
        int reloadTicks,
