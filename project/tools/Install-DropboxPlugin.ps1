...
$commit = 'e69c6f33023edeb0d704b64562b57c9611cb2b35'
...
if ($buildExitCode -ne 0) {
    throw 'DropboxAutoResourcePack verification failed'
}

$builtJar = Join-Path $sourceDirectory 'target\DropboxAutoResourcePack-1.1.0.jar'
...
Copy-Item -LiteralPath $builtJar -Destination (Join-Path $pluginsDirectory 'DropboxAutoResourcePack-1.1.0.jar') -Force
...
Write-Host "DropboxAutoResourcePack 1.1.0 installed from $actualCommit"
