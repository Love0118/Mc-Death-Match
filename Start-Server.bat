...
if not exist "plugins\DropboxAutoResourcePack\config.yml" (
    if exist "plugins\DropboxAutoResourcePack\config.example.yml" (
        copy /y "plugins\DropboxAutoResourcePack\config.example.yml" "plugins\DropboxAutoResourcePack\config.yml" >nul
    )
)
