...
맵은 회색 콘크리트 기반 300x300 다층 아레나입니다. 좌우의 긴 2층 데크와 중앙 구간의
3층 데크, 중앙 저층 구조물 및 넓은 엄폐물로 구성하며 8개의 3x3 슬라임 점프대를 사용합니다.
1층 점프대는 바닥에 매립되고 수평 이동을 건드리지 않은 채 수직 속도만 부여합니다.
