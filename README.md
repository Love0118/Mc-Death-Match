...
중지합니다. 승리 조건은 40킬이며 이동 속도는 0.5로 고정하고 점프 강도에는 0.5를 더합니다.
발광은 기존과 같이 적용됩니다. 체력은 100/100, 피해는 다리 30·몸통 50·머리 100이며
비전투 5초 뒤부터 초당 5를 회복합니다. 우클릭을 누르는 동안 조준하고 Q로 수동 재장전합니다.
