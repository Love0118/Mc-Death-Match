...
줌 배율은 유지하면서도 WASD 이동, 달리기, 웅크리기와 점프가 가능합니다.
조준 사격은 정확하며 비조준 사격에는 최대 5% 오차가 적용됩니다.

맵은 회색 콘크리트 기반 300x300 다층 아레나입니다. 좌우의 빈틈 없는 2층 구조와 중앙 구간의
3층 구조, 중앙 다층 구조물 및 촘촘한 엄폐물로 구성하며 16개의 3x3 슬라임 점프대를 사용합니다.
1층 점프대는 바닥에 매립됩니다. 맵 안의 모든 슬라임 블록은 수직 속도 1.55와 플레이어가
바라보는 수평 방향의 추가 가속 0.45를 적용합니다.
